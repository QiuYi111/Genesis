...
@dataclass
class ModelConfig:
    """Model configuration with provider abstraction support"""
    provider: str = "null"  # Default to null provider for deterministic execution
    api_key_env: str = "DEEPSEEK_API_KEY"  # Backward compatibility
    agent_model: str = "deepseek-chat"
    trinity_model: str = "deepseek-chat"
    ...
    provider_config: Dict[str, Any] = None  # Provider-specific settings
    timeout: float = 30.0
    max_tokens: int = 2048
